...
fun CrossKitApp(modifier: Modifier = Modifier) {
    // Generated by Cross-Kit. `remember...Bridge` creates the Rust VM, subscribes
    // to state updates, and closes the bridge from a DisposableEffect.
...
private fun CounterScreen(counter: CounterViewModelBridge, modifier: Modifier = Modifier) {
    Column(modifier = modifier, verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        // Compose observes generated mutable state. The screen does not poll
        // Rust or keep its own mirror of the counter value.
        Text(
